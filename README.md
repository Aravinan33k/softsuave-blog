...
Open **http://localhost:3100** for the blog and **/admin** to sign in (redirects to the login
page). Default seeded admin: `admin@example.com` / `ChangeMe!2026` — change it.
...
src/
  app/                  routes: (public) blog, /admin dashboard, /api/v1/*
  themes/               theme contract + registry + Minimal/Magazine
