 ...
 *
 * Three layouts over the same content:
 *
 * - `default` — an even grid (2-up on tablet, 4-up on desktop) with an accent
 *   rule along the card's top edge and an inline mono index. Left in place for
 *   the custom-AI page, which uses it.
 * - `bold` — the editorial treatment shared with the services grid: an
 *   asymmetric 12-column composition (see `spansFor`), an accent rule across
 *   the top, an oversized serif ordinal watermarked into the corner, and a
 *   per-card accent from the five-step warm brand ramp. See the BOLD CARD
 *   LAYOUT block in landing.module.css.
 ...
 *   so the layout is correct before any art or link targets exist.
 *
...
export default function Industries({
  ...
  return (
    <section className={styles.sectionShell} id={id}>
      ...
      <FadeUp>
        <div className={bold ? styles.boldGrid : styles.cardGrid}>
