...
/**
 * "hire-mean-stack-developers-india" — one of the 24 hire-by-skill landing pages.
 *
...
const skill = hireSkill('hire-mean-stack-developers-india');

export const revalidate = 300;

export const metadata: Metadata = hireMetadata(skill);

export default function HireMeanStackDevelopersIndiaPage() {
