...
import { webApp as content } from '@/lib/home/hire-roles';
import { hireRoleJsonLd, hireRoleMetadata } from '@/lib/home/hire-roles/page-meta';

/**
 * Hire Web App Developers — one of the nine "Hire Developers by Role" pages.
 *
 ...
 * all nine routes share; the copy is `lib/home/hire-roles/web-app.ts`.
 */
...
export default function HireWebAppDevelopersPage() {
  return (
    <>
