...
/**
 * "hire-ruby-on-rails-developer" — one of the 24 hire-by-skill landing pages.
 *
...
const skill = hireSkill('hire-ruby-on-rails-developer');

export const revalidate = 300;

export const metadata: Metadata = hireMetadata(skill);

export default function HireRubyOnRailsDeveloperPage() {
