...
import { blockchain as content } from '@/lib/home/hire-roles';
import { hireRoleJsonLd, hireRoleMetadata } from '@/lib/home/hire-roles/page-meta';

/**
 * Hire Blockchain Developers — one of the thirteen "Hire Developers by Role" pages.
 *
...
export default function HireBlockchainDeveloperPage() {
  return (
    <>
