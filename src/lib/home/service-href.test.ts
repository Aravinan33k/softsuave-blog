...
describe('matchServiceRoute', () => {
  it.each([
    ...
    ['Vue.js Development', '/vuejs-development-company'],
    ['Vue Migration Services', '/vuejs-development-company'],
    ['PostgreSQL Development', '/postgresql-development-company'],
    ['Postgres Performance Tuning', '/postgresql-development-company'],
